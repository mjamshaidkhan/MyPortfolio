...
import { upwork, upworkProfile } from "../assets";
  ...
  return (
    <div className="flex gap-2">
      ...
      <button
        ...
        onClick={() =>
          SocialMediaHandler("https://linkedin.com/in/muhammad-jamshaid")
        }
      >
        <svg
          className="w-5 h-5 fill-current"
      ...
      <button
        className="bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded"
        onClick={() => SocialMediaHandler("https://github.com/mjamshaidkhan")}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
